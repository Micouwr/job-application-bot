...
class JobScraper:
    ...
    def scrape_all(self, keywords: List[str], location: str, max_jobs: int = 50) -> List[Dict]:
        """
        ...
        """
        logger.warning("Automated scraping not yet implemented. Use add_manual_job() instead.")
        return self.jobs
