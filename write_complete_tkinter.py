...
"""
    ...
    def _create_add_job_tab(self, parent):
        ...
        self.clear_button = ttk.Button(
            button_frame, text=" Clear All", command=self.clear_fields
        )
    ...
    def _create_resume_mgmt_tab(self, parent):
        ...
        upload_btn = ttk.Button(
            control_frame, text=" Upload New Resume", command=self.upload_resume,
            style='Accent.TButton'
        )
        upload_btn.pack(side=tk.LEFT, padx=5)

        delete_btn = ttk.Button(
            control_frame, text=" Delete Selected", command=self.delete_selected_resume
        )
